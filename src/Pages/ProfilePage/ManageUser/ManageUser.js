                                ...
                                <div className="form-profile">
                                    <div className='table-responsive'>
                                        <table className='table table-striped table-hover'>
                                            ...
                                            <tbody>
                                                {loading ? <tr><td colSpan='6' className='text-center'>Loading...</td></tr> : !GetUsers.results.length ? <tr><td colSpan='6' className='text-center'>Empty Data</td></tr> : GetUsers.results.map((user, index) => {
                                                    return (<tr key={index}>
                                                        <td>{user.email}</td>
                                                        <td>{user.username}</td>
                                                        <td>{user.name}</td>
                                                        ...
                                                        <td>
                                                            <div className='d-flex'>
                                                                <button className='btn btn-primary mx-2' data-bs-toggle="modal" data-bs-target="#modalmovie"><FaEdit className='' /> </button>
                                                                <button className='btn btn-danger' ><FiTrash className='' /></button>
                                                            </div>
                                                        </td>
                                                    </tr>)
                                                })}
